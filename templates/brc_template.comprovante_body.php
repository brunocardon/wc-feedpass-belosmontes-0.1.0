	...
	<div class="brc-comprovante-reserva-a4">
		...
		<div class="brc-comprovante-reserva-body">
			...
			<div class="order-dados">
				...
				<?php
					$order_id = $order->id;
					include_once get_template_directory().'/includes/phpqrcode.php';
					$dir = get_template_directory().'/assets/img/qr/';
					$dirURI = get_template_directory_uri().'/assets/img/qr/';
					$qrpngfilename = 'mateusturismo'.$order_id.'qr.png';
					$passagemticket_uri = PASSAGEMTICKET_URI.'?p='.base64_encode($order_id);
					QRcode::png($passagemticket_uri, $dir.$qrpngfilename, QR_ECLEVEL_L, 7);
				?>
					<img src="<?php echo $dirURI.$qrpngfilename; ?>" alt="<?php echo $passagemticket_uri; ?>" />
